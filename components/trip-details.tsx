                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground leading-snug">
                          {isCombined && secondaryNationality ? (
                            <>
                              Visa requirements for {getCountryNameFromCode(nationality)} and {getCountryNameFromCode(secondaryNationality)} passport holders
                            </>
                          ) : (
                            <>
                              Visa requirements for {getCountryNameFromCode(nationality)} passport holders
                            </>
                          )}
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                ...
                                {combinedReq.bestPassport === 'secondary' && (
                                  <>
                                    {getCountryNameFromCode(secondaryNationality)}
                                  </>
                                )}
                                {combinedReq.bestPassport === 'both' && (
                                  <>
                                    Either passport works
                                  </>
                                )}
                              </p>
                            </div>
                        ...
                        <div className="pt-2 border-t border-border">
                          <p className="text-xs text-muted-foreground leading-snug">
                            Visa requirements change frequently. Always verify with official sources before travel.
                          </p>
                        </div>
...
export function TripDetails({ 
  ...
  const sensors = useSensors(
    useSensor(PointerSensor, {
      activationConstraint: {
        distance: 2, // Start drag with minimal movement
      },
    }),
  ...
  const apiLastUpdated = Object.values(visaRequirements).find((requirement) => requirement.lastUpdated)?.lastUpdated
